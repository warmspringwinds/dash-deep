...
def run():
    ...
    batch_size = 1#sql_db_model.batch_size
    learning_rate = 0.001#sql_db_model.learning_rate
    output_stride = 8#sql_db_model.output_stride
    gpu_id = 0 #sql_db_model.gpu_id
